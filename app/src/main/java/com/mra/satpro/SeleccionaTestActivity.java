...
public class SeleccionaTestActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_selecciona_test);
        ...
        lostaMaterias = new String[6];
        lostaMateriasImagen = new int[6];

        lostaMaterias[0] = "SAT Literature";
        lostaMaterias[1] = "SAT Math 1 & 2";
        lostaMaterias[2] = "SAT Biology E/M";
        lostaMaterias[3] = "SAT Chemistry";
        lostaMaterias[4] = "SAT Physics";
        lostaMaterias[5] = "SAT Spanish";

        lostaMateriasImagen[0] = R.mipmap.espanol_ios;
        lostaMateriasImagen[1] = R.mipmap.matematicas_ios;
        lostaMateriasImagen[2] = R.mipmap.biologia_ios;
        lostaMateriasImagen[3] = R.mipmap.quimica_ios;
        lostaMateriasImagen[4] = R.mipmap.fisica_ios;
        lostaMateriasImagen[5] = R.mipmap.razon_verbal_ios;
    ...
    private void mostrarInfoPago() {
        ...
        android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(SeleccionaTestActivity.this);
    ...
    public void consultarEscuelasSeleccionadas(){
        ...
        ListAdapter adapter3 = new SimpleAdapter(SeleccionaTestActivity.this,
    ...
    /*    if(v.getId()==findViewById(R.id.razmate).getId()){
        ...
        if(v.getId()==findViewById(R.id.img_flecha).getId()){
         ...
         /*   img_flecha.setImageResource(R.drawable.flecha_back);
            ...
            Log.e("Regreso", "Menu");
            finish();
            Intent linsertar=new Intent(SeleccionaTestActivity.this, MainActivity.class);
            startActivity(linsertar);
